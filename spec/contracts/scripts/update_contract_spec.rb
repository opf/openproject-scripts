...
RSpec.describe Scripts::UpdateContract do
  include_context "ModelContract shared context"

  shared_let(:script) { create(:script, name: "My Script", text: "1 + 1") }
